        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            of an input. Remember to place <code>&lt;CFormLabel&gt;</code>s outside the input group.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            While multiple <code>&lt;CFormInput&gt;</code>s are supported visually, validation styles
                            are only available for input groups with a single <code>&lt;CFormInput&gt;</code>.
                        </p>
